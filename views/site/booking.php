                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="car-details">
                                    ...
                                    <div class="price">
                                        <strong><?=$findcar->price?></strong> <span>$/for 8 day(s)</span> <i class="fa fa-info-circle"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="left">
                                   <!--  <form method="post"> -->
                                    ...
                                    <div class="checkbox checkbox-danger">
                                        <input id="checkboxl1" type="checkbox" name="choice" value="25" onchange="checkTotal()"/>
                                        <label for="checkboxl1"> <span class="pull-right">25 $ /for a day</span></label>
                                    </div>
                                    <div class="checkbox checkbox-danger">
                                    ...
                                    <div class="checkbox checkbox-danger">
                                        <input id="checkboxl3" type="checkbox" name="choice" value="42" onchange="checkTotal()"/>
                                        <label for="checkboxl3">Navigation <span class="pull-right">42 $ /Total</span></label>
                                    </div>
                                    <div class="checkbox checkbox-danger">
                                        <input id="checkboxl4" type="checkbox" name="choice" value="12" onchange="checkTotal()"/>
                                        <label for="checkboxl4">Excess Protection <span class="pull-right">12 $ /for a day</span></label>
                                    </div>
                                    <div class="checkbox checkbox-danger">
                                        <input id="checkboxl5" type="checkbox" name="choice" value="24" onchange="checkTotal()"/>
                                        <label for="checkboxl5">Additional Driver <span class="pull-right">24 $ /Total</span></label>
                                    </div>
                                </div>
                            </div>
                     Total: <input type="text" size="2" name="total" value="<?=$findcar->price?>"/ style="border:none">
                    </form>
