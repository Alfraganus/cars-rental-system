                ...
                <div class="row">
                    ...
                    <div class="col-md-9 content car-listing" id="content">
                        ...
                        <div class="thumbnail no-border no-padding thumbnail-car-card clearfix">
                            <div class="media">
                                <?php $image = app\models\Cargallary::find()->where(['category' => $car->car_id])->one();?>
                                <a class="media-link" data-gal="prettyPhoto" href="<?=Yii::$app->homeUrl;?>uploads/<?=$image->image;?>">

                                    <img src="<?=Yii::$app->homeUrl;?>uploads/<?=$image->image;?>"   style="width:370px;height:220px">
                            ...
                            <div class="caption">
                                ...
                                <h5 class="caption-title-sub">Start from <?=$car->price;?>kc per a day</h5>
                                ...
                                <table class="table">
                                    <tr>
                                        ...
                                        <td class="buttons"><a class="btn btn-theme" href="#">Rent It</a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
