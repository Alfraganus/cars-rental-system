...
if(isset($_REQUEST['start_date']) && isset($_REQUEST['end_date'])) {
	$model->event_start_date = $_REQUEST['start_date'];
	$model->event_end_date = $_REQUEST['start_date'];
}
...
/*	$model->event_start_date = Yii::$app->formatter->asDateTime($model->event_start_date);
	...
	$model->event_start_date = Yii::$app->formatter->asDatetime($model->event_start_date . Yii::$app->getTimeZone(),'php:D d-M-Y H:i:s');

	$model->event_end_date = Yii::$app->formatter->asDatetime($model->event_end_date . Yii::$app->getTimeZone(),'php:D d-M-Y H:i:s');
...
<div class="events-form">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
    <?= $form->field($model, 'event_start_date')->input('date')
    ?>
    </div>

    <div class="col-xs-12 col-sm-12 col-lg-12">
    <?= $form->field($model, 'event_end_date')->input('date')
    ?>
    </div>
