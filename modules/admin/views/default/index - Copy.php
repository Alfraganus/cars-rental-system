              ...
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-body table-responsive">
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr>
                        <td class="user-avatar"> <img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar6.png" alt="Avatar">Penelope Thornton</td>
                        <td>Topbar dropdown style</td>
                        <td>Aug 16, 2016</td>
                        <td class="actions"><a href="index.html#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar4.png" alt="Avatar">Benji Harper</td>
                        <td>Left sidebar adjusments</td>
                        <td>Jul 15, 2016</td>
                        <td class="actions"><a href="index.html#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar5.png" alt="Avatar">Justine Myranda</td>
                        <td>Main structure markup</td>
                        <td>Jul 28, 2016</td>
                        <td class="actions"><a href="index.html#" class="icon"><i class="mdi mdi-github-alt"></i></a></td>
                      </tr>
                      <tr>
                        <td class="user-avatar"> <img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar3.png" alt="Avatar">Sherwood Clifford</td>
        ...
        <div class="sb-content">
          <div class="tab-navigation">
            <ul role="tablist" class="nav nav-tabs nav-justified">
              <li role="presentation" class="active"><a href="index.html#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Chat</a></li>
              <li role="presentation"><a href="index.html#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Todo</a></li>
              <li role="presentation"><a href="index.html#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Settings</a></li>
            </ul>
          </div>
          <div class="tab-panel">
            <div class="tab-content">
              <div id="tab1" role="tabpanel" class="tab-pane tab-chat active">
                    ...
                    <div class="be-scroller">
                      <div class="content">
                        ...
                        <div class="contact-list contact-list-recent">
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar1.png" alt="Avatar">
                              <div class="user-data"><span class="status away"></span><span class="name">Claire Sassu</span><span class="message">Can you share the...</span></div></a></div>
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar2.png" alt="Avatar">
                              <div class="user-data"><span class="status"></span><span class="name">Maggie jackson</span><span class="message">I confirmed the info.</span></div></a></div>
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar3.png" alt="Avatar">
                              <div class="user-data"><span class="status offline"></span><span class="name">Joel King		</span><span class="message">Ready for the meeti...</span></div></a></div>
                        </div>
                        <h2>Contacts</h2>
                        <div class="contact-list">
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar4.png" alt="Avatar">
                              <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div></a></div>
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar5.png" alt="Avatar">
                              <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div></a></div>
                          <div class="user"><a href="index.html#"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar6.png" alt="Avatar">
                ...
                <div class="chat-window">
                  <div class="title">
                    <div class="user"><img src="<?=Yii::$app->homeUrl;?>backend/assets/img/avatar2.png" alt="Avatar">
